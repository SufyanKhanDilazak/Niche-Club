...
// Single banner image for men tees
...
export default function MenTeesPage() {
  ...
  const fetchProducts = useCallback(async () => {
   ...
   references(*[_type == "category" && title == "men-tees"]._id)
] {
  _id,
  name,
  slug,
  ...
  categories[]->{
    ...
    slug
      ...
      console.error('Error fetching men tees:', error)
            ...
            <div className="border border-blue-500 dark:border-[#a90068] bg-transparent backdrop-blur-md rounded-none sm:rounded-lg p-4 sm:p-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5 sm:gap-6">
                {isLoading ? (
                  ...
                  <div className="col-span-full text-center py-8">
                    <p className="text-gray-500 dark:text-gray-400 text-base sm:text-lg font-light">No men tees found</p>
                  </div>
                ) : (
                  memoizedProducts
                )}
