      ...
      <article className="relative">
        ...
        <div className="relative w-full aspect-[4/5] overflow-hidden bg-transparent rounded-sm">
          ...
          {firstImage?.asset?.url ? (
            ...
            <div className="w-full h-full flex items-center justify-center text-gray-400 text-sm font-light bg-gradient-to-br from-gray-50/50 to-gray-100/50 dark:from-gray-800/50 dark:to-gray-900/50">
              <span>No Image</span>
            </div>
          )}
   {/* badges */}
...
export default function NicheEssentialsPage() {
  ...
  const fetchProducts = useCallback(async () => {
    try {
      ...
      const query = `*[_type == "product" && references(*[_type == "category" && title == "men-essentials"]._id)] | order(_createdAt desc) {
  _id,
  name,
  slug,
  price,
  ...
  categories[]->{_id, title, slug}
      ...
      console.error('Error fetching men essentials:', err);
