...
const CategoryBanner = memo(function CategoryBanner({
  ...
  title = 'Leather Showcase',
  subtitle = 'Explore premium leather pieces crafted for bold, timeless style',
  className = '',
}: {
    ...
    <div className={`category-banner-container ${className}`}>
      <div className="category-banner">
        <div className="image-wrapper">
          <Image
            src="/leathercollection.png"
            alt="Leather Category Banner"
            fill
...
/* =========================
   Page (LeatherCollection)
   ========================= */
const LeatherCollection = memo(function LeatherCollection() {
  ...
  const fetchProducts = useCallback(async () => {
    try {
      ...
      // ✅ leather-collection (as requested)
      // Return BOTH the direct url and full asset so we can always resolve
      const query = `*[_type == "product" &&
  references(*[_type == "category" && title == "leather-collection"]._id) &&
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5">
              {isLoading ? (
                ...
                <div className="col-span-full text-center py-6">
                  <p className="text-red-500 dark:text-red-400 mb-3 text-sm sm:text-base font-light">
                    {error}
                  </p>
                  <button
...
LeatherCollection.displayName = 'LeatherCollection';
