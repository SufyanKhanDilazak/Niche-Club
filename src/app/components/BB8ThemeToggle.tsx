...
import { useTheme } from './theme-context'; // keep this path same as in your Header

type Props = {
  size?: number;      // base font-size for the toggle in px (controls whole widget)
  className?: string; // optional wrapper classes
};

export default function BB8ThemeToggle({ size = 16, className }: Props) {
  const { isDarkMode, toggleTheme, isThemeLoaded } = useTheme();
  const [mounted, setMounted] = useState(false);
  useEffect(() => setMounted(true), []);

  // Avoid hydration mismatch: render nothing until both are ready
  if (!mounted || !isThemeLoaded) return null;
  ...
  return (
    ...
    >
      ...
      {/* --- Uiverse (Galahhad) styles, scoped via styled-jsx --- */}
      <style jsx>{`
        .bb8-toggle {
          --toggle-size: 16px;
        ...
        .bb8__head {
          ...
          background:
            linear-gradient(transparent 0.063em, dimgray 0.063em 0.313em, transparent 0.313em 0.375em, var(--accent) 0.375em 0.5em, transparent 0.5em 1.313em, silver 1.313em 1.438em, transparent 1.438em),
          ...
          position: relative; z-index: 1; filter: drop-shadow(0 0.063em 0.125em gray);
        }
        .bb8__head::before {
        ...
        .bb8__body{
          ...
          border-radius: var(--radius); position: relative; overflow: hidden; transition: var(--transition); z-index: 1;
        ...
        .bb8__body::after{
          content:""; bottom:1.5em; left:0.563em; position:absolute; width:0.188em; height:0.188em; background:#ececec; border-radius:50%;
        ...
        .bb8__body::before{
          ...
          background:
            radial-gradient(1em circle at center, #ececec 50%, transparent 51%),
        ...
        .bb8__shadow{
          width: var(--bb8-diameter); height: 20%; border-radius: 50%; background: #3a271c;
          box-shadow: 0.313em 0 3.125em #3a271c; opacity: .25; position: absolute; bottom: 0;
        ...
        .bb8-toggle__cloud:nth-last-child(1){
          width:.875em;height:.625em; filter: blur(.125em) drop-shadow(.313em .313em #ffffffae) drop-shadow(-.625em 0 #fff) drop-shadow(-.938em -.125em #fff);
        ...
        .bb8-toggle__cloud:nth-last-child(2){
          top:.625em; right:4.375em; width:.875em; height:.375em; background:#dfdedeae;
        ...
        .bb8-toggle__cloud:nth-last-child(3){
          top:1.25em; right:.938em; width:.875em; height:.375em; background:#ffffffae;
        ...
        .gomrassen{ left:.938em; width:1.875em; height:1.875em; }
        .gomrassen::before,.gomrassen::after{
          content:""; position:absolute; border-radius:inherit; box-shadow: inset 0 0 0.063em rgb(140,162,169); background: rgb(184,196,200);
        }
        ...
        .tatto-1{ background:#fefefe; right:3.125em; top:.625em; box-shadow: 0 0 .438em #fdf4e1; }
        ...
        .bb8-toggle__star{
          position:absolute; width:.063em; height:.063em; background:#fff; border-radius: var(--radius);
          filter: drop-shadow(0 0 .063em #fff); color:#fff; top:100%;
        }
